...
import {
  IPageVerificationHandler,
  IPageVerificationHandlerData,
  IPageVerificationHandlerResponse,
...
@Injectable()
export class TwitterVerificationHandler implements IPageVerificationHandler {
  constructor(
