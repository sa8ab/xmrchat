...
export class AddDailySummery1751897366990 implements MigrationInterface {
    name = 'AddDailySummery1751897366990'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."page-settings_key_enum" AS ENUM('twitch-channel', 'obs-keep-messages', 'obs-play-sound', 'obs-auto-show-tips', 'min-notification-threshold', 'daily-summary-notification-time')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."notification_preferences_type_enum" AS ENUM('new_tip', 'daily_summary')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."page-settings_key_enum_old" AS ENUM('twitch-channel', 'obs-keep-messages', 'obs-play-sound', 'obs-auto-show-tips', 'min-notification-threshold', 'scheduled-daily-notification-time')`);
