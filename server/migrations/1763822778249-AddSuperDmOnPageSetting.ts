...
export class AddSuperDmOnPageSetting1763822778249 implements MigrationInterface {
    name = 'AddSuperDmOnPageSetting1763822778249'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."page-settings_category_enum" AS ENUM('obs', 'streaming', 'notifications', 'super-dm')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."page-settings_key_enum" AS ENUM('twitch-channel', 'obs-keep-messages', 'obs-play-sound', 'obs-auto-show-tips', 'obs-sound', 'min-notification-threshold', 'daily-summary-notification-time', 'super-dm-min-amount', 'super-dm-public-key')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "page-settings" DROP CONSTRAINT "unique-page-and-key"`);
        await queryRunner.query(`CREATE TYPE "public"."page-settings_key_enum_old" AS ENUM('twitch-channel', 'obs-keep-messages', 'obs-play-sound', 'obs-auto-show-tips', 'obs-sound', 'min-notification-threshold', 'daily-summary-notification-time')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."page-settings_category_enum_old" AS ENUM('obs', 'streaming', 'notifications')`);
