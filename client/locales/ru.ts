export default {
  ...
  quickAndEasy: {
    ...
    description:
      "ввести своё имя, сообщение, сумму, отсканировать QR-код для оплаты и отправить чаевые в XMR.",
  },
  openSource: {
    title: "Открытый код",
    description:
  ...
  accepted: {
    title: "Принимается",
    description:
      "принимать Monero на {xmrbazaar} и {monerica} или через консьерж-сервис {shopinbit}.",
  },
  andMore: {
