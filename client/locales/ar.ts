export default {
  ...
  quickAndEasy: {
    title: "سريع وسهل",
    description:
      "لا حاجة للمشاهدين لإنشاء حساب أو التحقق من بريدهم الإلكتروني أو إدخال بيانات بطاقة الائتمان. يذهب المعجبون إلى صفحة الإكراميات الخاصة بك، ويكتبون اسمهم ورسالتهم والمبلغ، ويمسحون رمز QR للدفع، ويرسلون إكراميتهم بعملة XMR.",
  },
  openSource: {
    title: "مفتوح المصدر",
