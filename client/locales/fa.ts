export default {
  ...
  quickAndEasy: {
    title: "سریع و آسان",
    description:
      "بینندگان نیازی به ایجاد حساب کاربری، تأیید ایمیل یا وارد کردن اطلاعات کارت اعتباری ندارند. هواداران به صفحه‌ی انعام شما مراجعه می‌کنند، نام، پیام و مبلغ خود را وارد می‌کنند، برای پرداخت یک کد QR را اسکن می‌کنند و انعام XMR خود را ارسال می‌کنند.",
  },
  openSource: {
    title: "متن باز",
    description:
  ...
  accepted: {
    title: "پذیرفته شده",
    description:
      "از دردسر فروش رمزارز خود در یک صرافی متمرکز اجتناب کنید. کالاها و خدمات را مستقیماً از فروشندگانی خریداری کنید که Monero را در {xmrbazaar} و {monerica} یا از طریق سرویس کنسیرژ {shopinbit} می‌پذیرند.",
  },
  andMore: {
    title: "و بیشتر",
    description:
  ...
  forContentCreators: {
    ...
    description: {
      ...
      streamyard: `به مورد منوی "Edit tip page" بروید. مطمئن شوید که نام کاربری کانال Twitch خود را اضافه کرده‌اید. هنگام شروع پخش زنده در Streamyard، Twitch را به‌عنوان مقصد اضافه کنید. ربات XMRChat (xmr-chat در Twitch) پیام انعام را در Twitch ارسال می‌کند و می‌توانید آن را از طریق Streamyard روی صفحه‌ی خود نمایش دهید. تنظیمات Automod در Twitch را بررسی کنید زیرا ممکن است سوپرچت‌های مورد نظر را فیلتر کند. لوگوی ربات xmrchat با تنظیم "Minimal" بهترین نمایش را دارد.`,
