export default {
  ...
  quickAndEasy: {
    title: "سریع و آسان",
    description:
      "نام، پیام و مبلغ خود را وارد کنند، برای پرداخت یک کد QR را اسکن کنند و انعام XMR خود را ارسال کنند.",
  },
  openSource: {
    title: "متن باز",
    description:
  ...
  accepted: {
    title: "پذیرفته شده",
    description:
      "پذیرش Monero در {xmrbazaar} و {monerica} یا از طریق سرویس کنسیرژ {shopinbit}.",
  },
  andMore: {
    title: "و بیشتر",
    description:
